function integrateGitment(router) {
    ...
    function renderGitment(fullPath) {
      const gitment = new Gitment({
        id: fullPath,
        owner: 'violaY33', // 必须是你自己的github账号
        repo: 'blog', // 上一个准备的github仓库
        oauth: {
          client_id: 'c4771ea98bee4091e66b', // 第一步注册 OAuth application 后获取到的 Client ID
          client_secret: '16db7787bf127aff22fa2f89941a18342d1cc093', // 第一步注册 OAuth application 后获取到的 Clien Secret
        },
      })
